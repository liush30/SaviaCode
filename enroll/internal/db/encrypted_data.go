...
// UpdateEncryptedData 更新加密数据
func UpdateEncryptedData(db *gorm.DB, data EncryptedData) error {
...
// DeleteEncryptedData 删除加密数据
func DeleteEncryptedData(db *gorm.DB, tedKey string) error {
	return db.Delete(&EncryptedData{}, "TED_KEY = ?", tedKey).Error
}
